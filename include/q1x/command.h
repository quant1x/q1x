...
namespace quant1x {
    ...
    constexpr const char * const default_all = "all";
    constexpr const char * const cmd_flag_all = "--all";
    constexpr const char * const cmd_flag_base = "--base";
    constexpr const char * const cmd_flag_features = "--features";
    constexpr const char * const cmd_flag_start = "--start";
    ...
    inline cmdFlags updateAll = {
        .use = cmd_flag_all,
        .value = "",
        .defaultValue = "",
        .usage = "全部"
    };
    inline cmdFlags updateBase = {
        .use = cmd_flag_base,
        .value = "",
        .defaultValue = default_all,
        .usage = "基础数据"
    };

    inline cmdFlags updateFeatures = {
        .use = cmd_flag_features,
        .value = "",
        .defaultValue = default_all,
        .usage = "特征数据"
    };

    inline cmdFlags updateStartDate = {
        .use = cmd_flag_start,
        .value = "",
