...
PROTOBUF_NAMESPACE_OPEN
template<> ::data::ChipDistribution* Arena::CreateMaybeMessage<::data::ChipDistribution>(Arena*);
template<> ::data::Chips* Arena::CreateMaybeMessage<::data::Chips>(Arena*);
template<> ::data::Line* Arena::CreateMaybeMessage<::data::Line>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace data {
...
class Line final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:data.Line) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:data.Line)
 private:
  class _Internal;
...
class Chips final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:data.Chips) */ {
 public:
  ...
  public:
  void clear_dist();
  ::data::Line* mutable_dist(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::data::Line >*
      mutable_dist();
  private:
  const ::data::Line& _internal_dist(int index) const;
  ::data::Line* _internal_add_dist();
  public:
  const ::data::Line& dist(int index) const;
  ::data::Line* add_dist();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::data::Line >&
      dist() const;
  ...
  // @@protoc_insertion_point(class_scope:data.Chips)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::data::Line > dist_;
...
class ChipDistribution final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:data.ChipDistribution) */ {
 public:
  ...
  public:
  void clear_list();
  ::data::Chips* mutable_list(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::data::Chips >*
      mutable_list();
  private:
  const ::data::Chips& _internal_list(int index) const;
  ::data::Chips* _internal_add_list();
  public:
  const ::data::Chips& list(int index) const;
  ::data::Chips* add_list();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::data::Chips >&
      list() const;

  // @@protoc_insertion_point(class_scope:data.ChipDistribution)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::data::Chips > list_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_proto_2fdata_2eproto;
...
inline int32_t Line::price() const {
  // @@protoc_insertion_point(field_get:data.Line.price)
...
inline void Line::set_price(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:data.Line.price)
}
...
inline double Line::buy() const {
  // @@protoc_insertion_point(field_get:data.Line.buy)
...
inline void Line::set_buy(double value) {
  ...
  // @@protoc_insertion_point(field_set:data.Line.buy)
}
...
inline double Line::sell() const {
  // @@protoc_insertion_point(field_get:data.Line.sell)
...
inline void Line::set_sell(double value) {
  ...
  // @@protoc_insertion_point(field_set:data.Line.sell)
}
...
inline const std::string& Chips::date() const {
  // @@protoc_insertion_point(field_get:data.Chips.date)
...
void Chips::set_date(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.date_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:data.Chips.date)
}
inline std::string* Chips::mutable_date() {
  std::string* _s = _internal_mutable_date();
  // @@protoc_insertion_point(field_mutable:data.Chips.date)
  return _s;
}
...
inline std::string* Chips::release_date() {
  // @@protoc_insertion_point(field_release:data.Chips.date)
...
inline void Chips::set_allocated_date(std::string* date) {
  ...
  // @@protoc_insertion_point(field_set_allocated:data.Chips.date)
}
...
inline ::data::Line* Chips::mutable_dist(int index) {
  // @@protoc_insertion_point(field_mutable:data.Chips.dist)
  return _impl_.dist_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::data::Line >*
Chips::mutable_dist() {
  // @@protoc_insertion_point(field_mutable_list:data.Chips.dist)
  return &_impl_.dist_;
}
inline const ::data::Line& Chips::_internal_dist(int index) const {
  return _impl_.dist_.Get(index);
}
inline const ::data::Line& Chips::dist(int index) const {
  // @@protoc_insertion_point(field_get:data.Chips.dist)
  return _internal_dist(index);
}
inline ::data::Line* Chips::_internal_add_dist() {
  return _impl_.dist_.Add();
}
inline ::data::Line* Chips::add_dist() {
  ::data::Line* _add = _internal_add_dist();
  // @@protoc_insertion_point(field_add:data.Chips.dist)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::data::Line >&
Chips::dist() const {
  // @@protoc_insertion_point(field_list:data.Chips.dist)
  return _impl_.dist_;
}
...
inline ::data::Chips* ChipDistribution::mutable_list(int index) {
  // @@protoc_insertion_point(field_mutable:data.ChipDistribution.list)
  return _impl_.list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::data::Chips >*
ChipDistribution::mutable_list() {
  // @@protoc_insertion_point(field_mutable_list:data.ChipDistribution.list)
  return &_impl_.list_;
}
inline const ::data::Chips& ChipDistribution::_internal_list(int index) const {
  return _impl_.list_.Get(index);
}
inline const ::data::Chips& ChipDistribution::list(int index) const {
  // @@protoc_insertion_point(field_get:data.ChipDistribution.list)
  return _internal_list(index);
}
inline ::data::Chips* ChipDistribution::_internal_add_list() {
  return _impl_.list_.Add();
}
inline ::data::Chips* ChipDistribution::add_list() {
  ::data::Chips* _add = _internal_add_list();
  // @@protoc_insertion_point(field_add:data.ChipDistribution.list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::data::Chips >&
ChipDistribution::list() const {
  // @@protoc_insertion_point(field_list:data.ChipDistribution.list)
  return _impl_.list_;
}
