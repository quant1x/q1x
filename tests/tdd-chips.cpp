...
//        //     d.kline.Open = Decimal(d.kline.Open, Digits);
//        //     d.kline.Close = Decimal(d.kline.Close, Digits);
//        //     d.kline.High = Decimal(d.kline.High, Digits);
//        //     d.kline.Low = Decimal(d.kline.Low, Digits);
//        //     d.Avg = Decimal(d.Avg, Digits);
...
//        double singlePrice = Decimal(day.kline.Close, Digits);
//
//        // 构造全量筹码分布
...
//            price = Decimal(price, digits); // 确保四舍五入
...
//    }
//
//    std::pair<double, double> findMaxPeak(double current, const std::vector<double>& prices, const std::map<double, double>& data) {
//        double maxVol = 0.0;
//        double peak = 0.0;
//        for (double p : prices) {
//            if (data.at(p) > maxVol) {
...
//
//    // 四舍五入函数
//    static double Decimal(double value, int digits) {
//        double scale = std::pow(10, digits);
...
//private:
//    // 计算单个特征点信息
//    PeakSignal calculateChipFeature(const std::vector<double>& prices, const std::map<double, double>& data, double total, bool isUpper) {
//        PeakSignal feature;
//
//        if (prices.empty()) {
//            return feature;
